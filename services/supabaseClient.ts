 ...
 */
export const withTimeout = async <T>(promise: Promise<T>, timeoutMs: number = 10000, errorMsg = "Request timed out"): Promise<T> => {
...
export const withRetry = async <T>(
    ...
    try {
        ...
        // Don't retry on Auth/Permission errors (401, 403) or Unique Constraint violations (23505)
